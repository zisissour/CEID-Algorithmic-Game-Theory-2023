                  ...
                  #First move (player has to play this one)
                         ...
                         if numMove==0 or finish==True:
                           ...
                           #Second move
                                ...
                                colOrRow=1#random.randint(0,1) # 0->column 1->row
                                screen_clear()
                                emptyCells=getEmptyCells(board,N)
                                sameColEmpty=[]
                                sameRowEmpty=[]
                                ...
                                if numMove==1 or finish==True:
                                   ...
                                   #Third move (last move)
                                     ...
                                     sameRowEmpty=[]
                                     for i in range(len(emptyCells)):
                                             column1,row1=getRowAndColumn(emptyCells[i],N)
                                             column2,row2=getRowAndColumn(move[0],N)
                                             if colOrRow==0:
                                                    if column1==column2:
                                                         sameColEmpty.append(emptyCells[i])
